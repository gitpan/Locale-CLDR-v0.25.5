...
has 'units' => (
	...
	default		=> sub { {
				'long' => {
					...
					'minute' => {
						'one' => q(aɖabaƒoƒo {0} wo),
						'other' => q(aɖabaƒoƒo {0} wo),
					},
					'month' => {
						'one' => q(ɣleti {0} wo),
						'other' => q(ɣleti {0} wo),
	...
	default		=> sub { {
		...
		'AUD' => {
			...
			display_name => {
				...
				'one' => q(ɔstraliaga dollar),
				'other' => q(ɔstraliaga dollar),
			},
		},
		'AWG' => {
			display_name => {
		...
		'CAD' => {
			symbol => 'CA$',
			display_name => {
				'currency' => q(kanadaga dollar),
				'one' => q(kanadaga dollar),
				'other' => q(kanadaga dollar),
			},
		},
		'CDF' => {
			display_name => {
		...
		'CNY' => {
			symbol => 'CN¥',
			display_name => {
				'currency' => q(tsainaga yuan),
				'one' => q(tsainaga yuan),
				'other' => q(tsainaga yuan),
			},
		},
		'COP' => {
			display_name => {
		...
		'GBP' => {
			symbol => '£',
			display_name => {
				'currency' => q(britainga pound sterling),
				'one' => q(britainga pound sterling),
				'other' => q(britainga pound sterling),
			},
		},
		'GEK' => {
			display_name => {
		...
		'IDR' => {
			display_name => {
				'currency' => q(indinesiaga rupiah),
				'one' => q(indinesiaga rupiah),
				'other' => q(indinesiaga rupiah),
			},
		},
		'IEP' => {
			display_name => {
		...
		'JPY' => {
			symbol => 'JP¥',
			display_name => {
				'currency' => q(dzapanga yen),
				'one' => q(dzapanga yen),
				'other' => q(dzapanga yen),
			},
		},
		'KES' => {
			display_name => {
		...
		'KRW' => {
			symbol => '₩',
			display_name => {
				'currency' => q(anyiehe koreaga won),
				'one' => q(anyiehe koreaga won),
				'other' => q(anyiehe koreaga won),
			},
		},
		'KWD' => {
			display_name => {
		...
		'MXN' => {
			symbol => 'MX$',
			display_name => {
				'currency' => q(meksikoga peso),
				'one' => q(meksikoga peso),
				'other' => q(meksikoga peso),
			},
		},
		'MYR' => {
			display_name => {
		...
		'RUB' => {
			display_name => {
				'currency' => q(rɔtsiaga ruble),
				'one' => q(rɔtsiaga ruble),
				'other' => q(rɔtsiaga ruble),
			},
		},
		'RUR' => {
			display_name => {
		...
		'SAR' => {
			display_name => {
				'currency' => q(saudiga riyal),
				'one' => q(saudiga riyal),
				'other' => q(saudiga riyal),
			},
		},
		'SBD' => {
			display_name => {
		...
		'SEK' => {
			display_name => {
				'currency' => q(swedenga krona),
				'one' => q(swedenga krona),
				'other' => q(swedenga krona),
			},
		},
		'SGD' => {
			display_name => {
		...
		'TRY' => {
			display_name => {
				'currency' => q(tɛkiiga lira),
				'one' => q(tɛkiiga lira),
				'other' => q(tɛkiiga lira),
			},
		},
		'TTD' => {
			display_name => {
		...
		'TWD' => {
			symbol => 'NT$',
			display_name => {
				'currency' => q(taiwanga yeye dollar),
				'one' => q(taiwanga yeye dollar),
				'other' => q(taiwanga yeye dollar),
			},
		},
		'TZS' => {
			display_name => {
		...
		'ZAR' => {
			display_name => {
				'currency' => q(anyiehe afrikaga rand),
				'one' => q(anyiehe afrikaga rand),
				'other' => q(anyiehe afrikaga rand),
			},
		},
		'ZMK' => {
			display_name => {
...
has 'time_zone_names' => (
	...
	default	=> sub { {
		...
		'Africa_Eastern' => {
			long => {
				'standard' => q(Ɣedzeƒe Afrika gaƒoƒome),
			},
			short => {
				'standard' => q(EAT),
			},
		...
		'Africa_Southern' => {
			long => {
				'standard' => q(Anyiehe Afrika gaƒoƒome),
			},
			short => {
				'standard' => q(SAST),
			},
		...
		'Africa_Western' => {
			long => {
				'daylight' => q(Ɣetoɖoƒe Afrika dzomeŋɔli gaƒoƒome),
				'generic' => q(Ɣetoɖoƒe Afrika gaƒoƒome),
		...
		'America_Central' => {
			long => {
				'daylight' => q(Titina Amerika ŋkekeme gaƒoƒome),
				'generic' => q(Titina Amerika gaƒoƒome),
				'standard' => q(Titina Amerika gaƒoƒoɖoanyime),
			},
		},
		'America_Eastern' => {
			long => {
				'daylight' => q(Ɣedzeƒe Amerika ŋkekeme gaƒoƒome),
				'generic' => q(Ɣedzeƒe Amerika gaƒoƒome),
				'standard' => q(Ɣedzeƒe Amerika gaƒoƒoɖoanyime),
			},
		},
		'America_Mountain' => {
			long => {
				'daylight' => q(Amerika Todzidukɔwo ƒe ŋkekme gaƒoƒome),
				'generic' => q(Amerika Todzidukɔwo ƒe gaƒoƒome),
				'standard' => q(Amerika Todzidukɔwo ƒe gaƒoƒoɖoanyime),
			},
		},
		'America_Pacific' => {
			long => {
				'daylight' => q(Amerika Pasifik ŋkekeme gaƒoƒome),
				'generic' => q(Amerika Pasifik gaƒoƒome),
				'standard' => q(Amerika Pasifik gaƒoƒoɖoanyime),
			},
		},
		'Anadyr' => {
			long => {
		...
		'Asia/Chongqing' => {
			exemplarCity => q#Tsongking nutomegaƒoƒome#,
		},
		'Asia/Colombo' => {
		...
		'Asia/Harbin' => {
			exemplarCity => q#Harbin nutomegaƒoƒome#,
		},
		'Asia/Hong_Kong' => {
		...
		'Asia/Kashgar' => {
			exemplarCity => q#Kashgar nutomegaƒoƒome#,
		},
		'Asia/Katmandu' => {
		...
		'China' => {
			long => {
				'daylight' => q(Tsaina ŋkekeme gaƒoƒome),
				'generic' => q(Tsaina gaƒoƒome),
				'standard' => q(Tsaina gaƒoƒoɖoanyime),
			},
		},
		'Choibalsan' => {
			long => {
		...
		'Europe_Central' => {
			long => {
				'daylight' => q(Titina Yuropa dzomeŋɔli gaƒoƒome),
				'generic' => q(Titina Yuropa gaƒoƒome),
				'standard' => q(Titina Yuropa gaƒoƒoɖoanyime),
			},
		},
		'Europe_Eastern' => {
			long => {
				'daylight' => q(Ɣedzeƒe Yuropa dzomeŋɔli gaƒoƒome),
				'generic' => q(Ɣedzeƒe Yuropa gaƒoƒo me),
				'standard' => q(Ɣedzeƒe Yuropa gaƒoƒoɖoanyime),
			},
		},
		'Europe_Western' => {
			long => {
				'daylight' => q(Ɣetoɖoƒe Yuropa dzomeŋɔli gaƒoƒome),
				'generic' => q(Ɣetoɖoƒe Yuropa gaƒoƒome),
				'standard' => q(Ɣetoɖoƒe Yuropa gaƒoƒoɖoanyime),
			},
		},
		'Falkland' => {
			long => {
		...
		'Japan' => {
			long => {
				'daylight' => q(Dzapan ŋkekeme gaƒoƒome),
				'generic' => q(Dzapan gaƒoƒome),
				'standard' => q(Dzapan gaƒoƒoɖanyime),
			},
		},
		'Kamchatka' => {
			long => {
		...
		'Moscow' => {
			long => {
				'daylight' => q(Mɔskow dzomeŋɔli gaƒoƒome),
				'generic' => q(Mɔskowgaƒoƒome),
				'standard' => q(Mɔskow gaƒoƒoɖoanyime),
			},
		},
		'Newfoundland' => {
			long => {
