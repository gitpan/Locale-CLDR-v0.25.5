...
has 'curriencies' => (
	...
	default		=> sub { {
		...
		'XAF' => {
			symbol => 'FCFA',
			display_name => {
				'currency' => q(CFA フラン（BEAC）),
				'other' => q(CFA フラン（BEAC）),
			},
		},
		'XAG' => {
			display_name => {
		...
		'XOF' => {
			symbol => 'CFA',
			display_name => {
				'currency' => q(CFA フラン（BCEAO）),
				'other' => q(CFA フラン（BCEAO）),
			},
		},
		'XPD' => {
			display_name => {
